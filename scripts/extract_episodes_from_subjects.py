...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_process', type=int, help="number of processes to spawn to do task concurrently", default=1)
    ...
    subjects = os.listdir(args.subjects_root_path)
    
    for i in range(0, args.num_process):
        portion = int(len(subjects) / args.num_process)
        if i != args.num_process - 1:
