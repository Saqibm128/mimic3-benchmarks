...
def main():
    ...
    for (index, subject) in enumerate(subjects):
        ...
        if os.path.isfile(os.path.join(args.subjects_root_path, subject, "events.csv")):
            ...
            toProofread = eventsDF.merge(staysDF, left_on=["SUBJECT_ID", "HADM_ID"], right_on=["SUBJECT_ID", "HADM_ID"], how="left", suffixes=["", "_r"])
            ...
            toWrite = toProofread[["SUBJECT_ID", "HADM_ID", "ICUSTAY_ID", "CHARTTIME", "VALUE", "VALUEUOM"]] # remove any weird _l columns from merge
